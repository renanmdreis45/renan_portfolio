    ...
    return(
        <div className = 'nav-bar'> 
            <Link className = "logo" to="/"> 
                <img src = {RM} alt="logo" height={100} width={125}/>
            ...
            <ul>
                <li>
                    <a target = "_blank" rel = "noreferrer" href = "https://www.linkedin.com/in/renanmdreis/">
                        <FontAwesomeIcon icon={faLinkedin} color = "#4d4d4e" />
                    </a>
                </li>
                <li>
                    <a target = "_blank" rel = "noreferrer" href = "https://github.com/renanmdreis45">
                        <FontAwesomeIcon icon={faGithub} color = "#4d4d4e" />
                    </a>
                </li>
                <li>
                    <a target = "_blank" rel = "noreferrer" href = "mailto:renanmdreis@gmail.com">
